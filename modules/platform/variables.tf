...
variable "public_subnet_cidrs" {
  ...
  validation {
    ...
    error_message = "至少需要两个 Public Subnet CIDR。"
  }
}
...
variable "private_app_subnet_cidrs" {
  ...
  validation {
    ...
    error_message = "至少需要两个 Private Application Subnet CIDR。"
  }
}
...
variable "private_db_subnet_cidrs" {
  ...
  validation {
    ...
    error_message = "至少需要两个 Private Database Subnet CIDR。"
  }
}
...
variable "single_nat_gateway" {
  description = "是否共享单个 NAT Gateway。"
  type        = bool
  default     = true
  nullable    = false
  validation {
...
variable "ecs_memory" {
  ...
  validation {
    ...
    error_message = "ecs_memory 至少 512 MiB。"
  }
}
